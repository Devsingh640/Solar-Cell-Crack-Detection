...
# implementing basic gradient boosting classifier.
print("implementing basic gradient boosting classifier.")
print("##########################################################################")
print("clf1 in process please wait for results.")
clf1 = GradientBoostingClassifier(n_estimators=num_trees, random_state=seed)
print("Calculating  results.") 
results_gbc = model_selection.cross_val_score(clf1, X, Y, cv = kfold)
print("Results(MEAN) : ", results_gbc.mean())
print("##########################################################################")
print(" ")
# basic gradient boosting classifier implementation completed here.