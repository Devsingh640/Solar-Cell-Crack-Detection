...
# implementing basic bagged decision tree classifier.
print("implementing basic random forest classifier.")
print("##########################################################################")
print("clf1 in process please wait for results.")
clf1 = RandomForestClassifier(n_estimators=num_trees, max_features=max_features)
print("Calculating  results.") 
results_rfc = model_selection.cross_val_score(clf1, X, Y, cv = kfold)
